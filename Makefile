...
# Project:  sudoku.pro
# Template: app
# Command: /home/me/anaconda3/bin/qmake -o Makefile sudoku.pro
#############################################################################
...
QMAKE         = /home/me/anaconda3/bin/qmake
DEL_FILE      = rm -f
...
DISTDIR = /home/me/Desktop/sudoku/.tmp/sudoku1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-rpath,/home/me/anaconda3/lib
LIBS          = $(SUBLIBS) -lQt5Widgets -L/home/me/anaconda3/lib -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
SOURCES       = View/SudokuTableView.cpp \
		View/SudokuWidget.cpp \
		Model/SudokuModel.cpp \
		SudokuApp.cpp \
		Model/SudokuInitiator.cpp 
OBJECTS       = SudokuTableView.o \
		SudokuWidget.o \
		SudokuModel.o \
		SudokuApp.o \
		SudokuInitiator.o
DIST          = ../../anaconda3/mkspecs/features/spec_pre.prf \
		...
		sudoku.pro View/SudokuTableView.h \
		View/SudokuWidget.h \
		Model/SudokuModel.h \
		Model/SudokuInitiator.h View/SudokuTableView.cpp \
		View/SudokuWidget.cpp \
		Model/SudokuModel.cpp \
		SudokuApp.cpp \
		Model/SudokuInitiator.cpp
...
Makefile: sudoku.pro ../../anaconda3/mkspecs/linux-g++/qmake.conf ../../anaconda3/mkspecs/features/spec_pre.prf \
		../../anaconda3/mkspecs/common/unix.conf \
		../../anaconda3/mkspecs/common/linux.conf \
		../../anaconda3/mkspecs/common/sanitize.conf \
		../../anaconda3/mkspecs/common/gcc-base.conf \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents View/SudokuTableView.h View/SudokuWidget.h Model/SudokuModel.h Model/SudokuInitiator.h $(DISTDIR)/
	$(COPY_FILE) --parents View/SudokuTableView.cpp View/SudokuWidget.cpp Model/SudokuModel.cpp SudokuApp.cpp Model/SudokuInitiator.cpp $(DISTDIR)/
...
SudokuTableView.o: View/SudokuTableView.cpp View/SudokuTableView.h \
		...
		Model/SudokuInitiator.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o SudokuTableView.o View/SudokuTableView.cpp

SudokuWidget.o: View/SudokuWidget.cpp View/SudokuWidget.h \
		../../anaconda3/include/qt/QtWidgets/QTableView \
		../../anaconda3/include/qt/QtWidgets/qtableview.h \
		../../anaconda3/include/qt/QtWidgets/qabstractitemview.h \
		../../anaconda3/include/qt/QtWidgets/qabstractscrollarea.h \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o SudokuWidget.o View/SudokuWidget.cpp

SudokuModel.o: Model/SudokuModel.cpp Model/SudokuModel.h \
		../../anaconda3/include/qt/QtCore/QModelIndex \
		../../anaconda3/include/qt/QtCore/qabstractitemmodel.h \
		../../anaconda3/include/qt/QtCore/qvariant.h \
		../../anaconda3/include/qt/QtCore/qatomic.h \
		...
		../../anaconda3/include/qt/QtCore/QString \
		Model/SudokuInitiator.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o SudokuModel.o Model/SudokuModel.cpp

SudokuApp.o: SudokuApp.cpp ../../anaconda3/include/qt/QtWidgets/QApplication \
		...
		../../anaconda3/include/qt/QtWidgets/qlayoutitem.h \
		../../anaconda3/include/qt/QtWidgets/qgridlayout.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o SudokuApp.o SudokuApp.cpp

SudokuInitiator.o: Model/SudokuInitiator.cpp Model/SudokuInitiator.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o SudokuInitiator.o Model/SudokuInitiator.cpp
